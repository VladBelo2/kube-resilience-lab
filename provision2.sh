...
#   cd /home/vagrant/kube-resilience-lab
...
[[ -n "$bridged_ip" ]] && {
  ...
  echo "🐍 Flask:         http://flask.kube-lab.local"
  ...
  echo "192.168.56.120 flask.kube-lab.local grafana.kube-lab.local prometheus.kube-lab.local k8s-dashboard.kube-lab.local"
}
